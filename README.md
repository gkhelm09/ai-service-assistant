...
A simple Streamlit web application that helps biomedical field service engineers troubleshoot equipment problems. Responses are simulated locally—no external AI API is required.
